...
namespace BLL.Services
{
    public class UserService: IUserService
    {
        ...
        // Create
        public async Task<(bool Success, string? Error)> Create(User user, string creator)
        {
        ...
        // Update
        public async Task<string?> UpdateUserInfoAsync(string login, UpdateUserDto userDto, string modifiedBy)
        {
        ...
        public async Task<string?> ChangeLoginAsync(string currentLogin, string newLogin, string modifiedBy)
        {
            if (!newLogin.All(char.IsLetterOrDigit))
        ...
        // Delete
        public async Task<(bool Success, string? Error)> Delete(string login, string adminLogin)
        {
            var user = await _userRepository.GetByLoginAsync(login);
        ...
        // Restore
        public async Task<(bool Success, string? Error)> RestoreAsync(string login)
        {
            var user = await _userRepository.GetByLoginAsync(login);
            if (user == null) return (false, "User not found");
